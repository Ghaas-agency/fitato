    ...
    <Layout>
      <div className="college-page">
        ...
        <section className="college-hero">
          <div className="container">
            <div className="college-hero__wrapper">
              <h1>Become a <span className="yellow">#FitatoCampusChampion</span></h1>
              <p className="yellow">Be The Fitness Star On Your Campus</p>
              <a href="#signup" className="button-inverted">Sign up</a>
            </div>
          </div>
        </section>
        ...
        <section className="college-who">
          <div className="container">
            <h2>Would you like to be a<br/><span className="yellow">#FitatoCampusChampion?</span></h2>
            <p>Fitato is a fitness membership that is revolutionising the way people in Pune think about fitness. And we want you to help us bring this revolution to your college! If you&apos;re deeply passionate about fitness and see yourself as a changemaker - hop on this journey with us. As a Fitato Campus Champion - you&apos;ll get exclusive Champion-only access to merchandise, cool parties and you&apos;ll get to be the face of fitness in your college.</p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="college-what__items">
              <div className="college-what__item">
                <img src={withPrefix('/static/champion/id-card.png')} alt="id card"/>
                <h3>Free Fitato Membership</h3>
                <p>For all Fitato Champions</p>
              </div>
              <div className="college-what__item">
                <img src={withPrefix('/static/champion/tickets.png')} alt="tickets."/>
                <h3>Your Due Share</h3>
                <p>Commission on the sales you make</p>
              </div>
              <div className="college-what__item">
                <img src={withPrefix('/static/champion/discount.png')} alt="discount"/>
                <h3>Resume Boost</h3>
                <p>Experience letter to credit your work</p>
              </div>
              <div className="college-what__item">
                <img src={withPrefix('/static/champion/resume.png')} alt="resume"/>
                <h3>Free Supersonic Passes</h3>
                <p>Two passes for the top performing champion</p>
              </div>
              <div className="college-what__item">
                <img src={withPrefix('/static/champion/merchandise.png')} alt="merchandise"/>
          ...
          <div className="container">
            ...
            <div className="college-be__items">
              <div className="college-be__item">
                ...
                <p>We want you to help us help your college mates adopt a fitter lifestyle. The more people you bring in, the bigger the cause becomes! You would be in charge of getting more and more people to know about us and join our revolution of providing fitness freedom that comes with a Fitato membership.</p>
              </div>
              <div className="college-be__item">
                <h3>Lead the Fitness Revolution Online</h3>
                <p>We want you to help us spread the idea of making fitness a priority in their lifestyle. You would be our social media influencer and lead the #fitato campaign across social media platforms by inspiring people to stay fit.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="college-get">
          <div className="container">
            <h2>What do you need to be a <br/><span className="yellow">#FitatoCampusChampion?</span></h2>
            <p>All you need is a strong passion for fitness and a desire to make people’s lives healthier. Needless to say, you must still be in college. Your relationship with us will go on for at least two months (December and January).</p>
          </div>
        </section>

        <section className="college-signup" id="signup">
          <div className="container">
            <h2>So, you think you have what it takes?<br/><span className="yellow">Sign up now!</span></h2>

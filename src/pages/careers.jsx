    ...
    <Layout>
      <CareersHero>
        <div className="container align-center">
          ...
          <p className="white">
            At Fitato, we aim to build careers, instead of providing jobs.
            Careers are built around passion. Fitato is built on a shared
            passion for fitness and a healthy lifestyle. And that’s all you’d
          ...
          <div className="items">
            <div className="item">
              ...
              <p>
                ...
                professionals with the shared vision of making India fall in
                love with fitness by empowering them with the Fitato way of
                life.
              </p>
            </div>
            <div className="item">
              ...
              <p>
                ...
                Membership is a single, flexible membership that gets them
                access to the best gyms and fitness studios around them.
              </p>
            </div>
            <div className="item">
              <img
              ...
              />
              <p>
                We, at Fitato, strongly believe that what people take 20 years
                to achieve, can be achieved in two, with passion, devotion and
                hard work. And we strive each day to make that a reality.
              </p>
            </div>
          </div>
        </div>
      ...
      <CareersWhy>
        <div className="container white">
          ...
          <p
            ...
            As said earlier, the driving force for any person who works in
            Fitato is their passion towards a fit and healthy lifestyle. Beyond
            that, here’s what working with Fitato means:
          </p>
          <div className="items">
            <div className="left">
              ...
              <p>
                ...
                sky-rocketing sales or successful events. Some days you’d find
                us brainstorming next steps and planning the next big thing in
                the fitness landscape. We assure you, we won’t let you get bored
                with work.
              </p>
            </div>
            <div className="right">
          ...
          <div className="items">
            ...
            <div className="left">
              ...
              <p>
                ...
                And the freedom to explore and grow the way they wish. At
                Fitato, you’d not be tied to one profile. You can explore, seek
                and learn beyond your role and grow in your career the way you
                want.
              </p>
            </div>
          </div>
      ...
      <CareersJoin>
        <div className="container">
          <div className="items">
            <div className="item">
              <h2 className="uppercase heading-underline left">
                Join our team
              </h2>
              <p>

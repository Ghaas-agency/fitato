        ...
        <Layout>
          <div className="comm-page">
            <Helmet
              ...
              style={[{
                "cssText": `
                .comm-hero {background-image: url('${withPrefix('/static/community/fitato-community-hero.jpg')}')} @media (max-width: 767px) {.comm-hero {background-image: url('${withPrefix('/static/community/fitato-community-hero-mobile.jpg')}')}}
                .comm-community {background-image: url('${withPrefix('/static/index/fitato-community-bg.jpg')}')}
                `
              }]}
            >
              <meta name="description" content="Join us for a free community workout at a time and location that works for you." />
              <meta itemprop="name" content="Experience the Fitato Way of Life | Join Fitato Community"/>
              <meta itemprop="description" content="Join us for a free community workout at a time and location that works for you."/>
              <meta name="twitter:title" content="Experience the Fitato Way of Life | Join Fitato Community"/>
              <meta name="twitter:description" content="Join us for a free community workout at a time and location that works for you."/>
              <meta property="og:title" content="Experience the Fitato Way of Life | Join Fitato Community"/>
              <meta property="og:description" content="Join us for a free community workout at a time and location that works for you."/>
            </Helmet>
            ...
            <section className="comm-hero">
              <div className="container">
                <div className="comm-hero__wrapper">
                  ...
                  <a href="#join-community" className="button" style={{marginLeft: '0'}}>Claim your community workout</a>
                </div>
              </div>
            </section>
                ...
                <div className="comm-join__items">
                  ...
                  <div className="comm-join__item">
                    <div id="mc_embed_signup">
                      <form action="https://fit.us18.list-manage.com/subscribe/post?u=c70dd7220cee163ff5b3fa95d&amp;id=c05180cc83" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
                        <div id="mc_embed_signup_scroll">
                          <div className="mc-field-group">
                            <label htmlFor="mce-FNAME">Name </label>
                            <input type="text" name="FNAME" className="required" id="mce-FNAME" placeholder="Ashok Kumar"/>
                          </div>
                          <div className="mc-field-group">
                          ...
                          <div className="mc-field-group">
                            ...
                            <input type="text" name="LOCATION" className="required" id="mce-LOCATION" placeholder="Viman Nagar, Pune"/>
                          </div>
            ...
            <a href="#join-community" className="comm-cta button" style={(this.state.showCTA ? {bottom: '20px'} : {bottom: '-70px'})}>Claim your free workout</a>

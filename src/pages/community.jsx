...
class CommunityPage extends React.Component {
  ...
  render() {
    return (
      <>
        <Layout>
          <Helmet title="Experience the Fitato Way of Life | Join Fitato Community">
            <meta
              name="description"
          ...
          <CommAbout>
            <div className="container">
              <div className="wrapper">
                <h2>About Fitato</h2>
                <p>
                  Fitato is a hyper-local fitness solution that aims at
                  providing you fitness freedom. With a single membership, you
                  get access to the best gyms and fitness centres in your city
                  anytime you want.
                </p>
              </div>
            </div>
            ...
            <div className="container">
              <div className="wrapper">
                ...
                <p style={{ marginBottom: 25 }}>
                  The Fitato Community gets to enjoy Fitato Exclusive Events
                  that we host weekly. Fitato exclusive events include a range
                  of fitness expeditions like thrilling treks, relaxing yoga
                  carnival and exciting fitness pool parties. We have everything
                  from sports tournaments to aqua fests for you to indulge in.
                </p>
                <p style={{ marginBottom: 20 }}>
                  Sounds interesting, right? We have a whole bunch of memories
                  for you to know what our Exclusives really are.
                </p>
                <a
                  href="https://fitato.page.link/app"
                  target="_blank"

...
class WorkplacePage extends React.Component {
  ...
  handleClick = e => {
    if(e.target.className === 'workplace-modalbg' || e.target.className === 'modal-close' || e.target.parentElement.className === 'modal-close') {
      this.setState({
        modalToggle: false
      });
    } else {
    ...
    return (
      <Layout>
        ...
        <div className="workplace-page">
          ...
          <div className="workplace-section-intro" style={{backgroundImage: 'url(' + withPrefix('/static/workplace/fitato-for-workplace-bg.jpg') + ')'}}>
            <div className="container">
              <div className="workplace-section-intro__content">
                <h1>Holistic Wellness For The New Age Workplace</h1>
                <p>Get the Fitato advantage for your employees and see the happiness, health and productivity soar!</p>
                <span className="button" style={{marginLeft: '0'}} onClick={this.handleClick}>Learn More</span>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              ...
              <div className="workplace-section-your__items">
                <div className="workplace-section-your__item">
                  <img src={withPrefix('/static/workplace/mind.svg')} alt="mind"/>
                  <h3>Mentally Fit</h3>
                  <p>An uncluttered mind will always triumph. Our corporate wellness program includes activities and exercises that boost productivity, decreas stress levels, increase creativity and guarantee great results. Show your employees you care with our corporate wellness program.</p>
                </div>
                <div className="workplace-section-your__item">
                  <img src={withPrefix('/static/workplace/body.svg')} alt="body"/>
                  <h3>Physically Fit</h3>
                  <p>Give your employees the gift of health! Healthier employees mean less absenteeism, better performance, and faster results. Employees are the most important asset in your organization and your healthy, happy employees will stay with you for a long, long time.</p>
                </div>
                <div className="workplace-section-your__item">
                  <img src={withPrefix('/static/workplace/community.svg')} alt="community"/>
                  <h3>Socially Fit</h3>
                  <p>Tough times never last, tough teams do. Our workplace wellness program boosts employee morale and encourages camaraderie and teamwork. Happier employees support each other and work towards a common goal.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="workplace-section-about">
            <div className="container">
              ...
              <p>Fitato is a hyperlocal, tech-enabled fitness solution which is sweeping India by storm. Gift your employees a single membership pass to access the best gyms and fitness studios across the city - so your employees can access  gyms they want, whenever and wherever they want.</p>
              <p>What’s more, our customized corporate plans bring you a variety of on-demand fitness sessions right at your workplace.</p>
              <p>This is the corporate fitness program for the new age offices!</p>
              <span className="button" onClick={this.handleClick}>Get in touch</span>
            </div>
          </div>
            ...
            <div className="container">
              <div className="workplace-section-employees__wrapper">
                ...
                <div className="workplace-section-employees__row">
                  <div>
                    <h3>For Employees</h3>
                    <p>Each and every one of your employees and team members get a flexible fitness plan they’re bound to love. Customised fitness options - from Yoga to MMA, Crossfit to Swimming, there’s something for everybody!</p>
                    <p>Nothing says Employee Benefits better than a Fitato Pass. </p>
                  </div>
                  <div className="workplace-section-employees__row--img">
                    <img src={withPrefix('/static/workplace/employees.svg')} alt="employee" />
                  </div>
                </div>
                <div className="workplace-section-employees__row">
                  <div className="workplace-section-employees__row--img workplace-section-employees__row--img2">
                    <img src={withPrefix('/static/workplace/employer.svg')} alt="employer" />
                  </div>
                  <div className="workplace-section-employees__row--c2">
                    <h3>For Employers</h3>
                    <p>It’s very difficult to make everyone happy. And run it well! Fitato For Workplaces is built for the new age workplace. All the stats you need, on a single dashboard. Plus a range of in-office activities you can choose from.</p>
          ...
          <div className="workplace-section-why">
            <div className="container">
              <h2>The Corporate Wellness Program<br />for the Indian Workplace</h2>
              <div className="workplace-section-why__items">
                <div className="workplace-section-why__item">
                  <div className="workplace-section-why__item--left">
                    <img src={withPrefix('/static/workplace/money.svg')} alt="money" />
                  </div>
                ...
                <div className="workplace-section-why__item">
                  <div className="workplace-section-why__item--left">
                    <img src={withPrefix('/static/workplace/barbell.svg')} alt="barbell" />
                  </div>
                  <div className="workplace-section-why__item--right">
                ...
                <div className="workplace-section-why__item">
                  <div className="workplace-section-why__item--left">
                    <img src={withPrefix('/static/workplace/face.svg')} alt="face" />
                  </div>
                  <div className="workplace-section-why__item--right">
                ...
                <div className="workplace-section-why__item">
                  <div className="workplace-section-why__item--left">
                    <img src={withPrefix('/static/workplace/clock.svg')} alt="clock" />
                  </div>
                  <div className="workplace-section-why__item--right">
              ...
              <span className="button align-center" onClick={this.handleClick}>Arrange a Call Back</span>
            </div>
          </div>
          ...
          <div className="workplace-section-clients">
            <div className="container">
              ...
              <div className="workplace-section-clients__items">
                ...
                <div className="workplace-section-clients__item">
                  <img src={withPrefix('/static/workplace/infosys.png')} alt="infosys"/>
                </div>
                <div className="workplace-section-clients__item">
                ...
                <div className="workplace-section-clients__item">
                  <img src={withPrefix('/static/workplace/zocdoc.png')} alt="zocdoc"/>
                </div>
                <div className="workplace-section-clients__item">
                  <img src={withPrefix('/static/workplace/bajaj-finserv.png')} alt="bajaj finserv"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="workplace-section-happy">
            <div className="container">
              <h2>Testimonials</h2>
              <p><em>"Our team has loved such an innovative and personalised approach to wellness. It gives us all the opportunity to go to new styles of fitness we've been wanting to try for a while. Best of all, many of our employees use Fitato to stay active together."</em></p>
            </div>
          </div>
              ...
              <div className="workplace-section-plans__items">
                {/* <div className="workplace-section-plans__item">
                  ...
                  <div className="workplace-section-plans__item--content">
                    ...
                    <span className="button button-fluid" onClick={this.handleClick}>Get Started</span>
                  </div>
                </div> */}
                <div className="workplace-section-plans__item">
                  <div className="workplace-section-plans__item--title">
                  ...
                  <div className="workplace-section-plans__item--content">
                    ...
                    <p><strong>Additional Nutrition &amp; Wellness Sessions</strong></p>
                    <span className="button button-fluid" onClick={this.handleClick}>Learn More</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="workplace-section-app">
            <div className="container">
              <div className="workplace-section-app__item">
                ...
                <p>Become a Fitato member, choose your next workout from many categories and reserve the activity — all through the Fitato app.</p>
                <AppIcons />
              </div>
              <div className="workplace-section-app__item align-center">
                <img src={withPrefix('/static/fitato-app.png')} className="workplace-section-app__item--img" alt="fitato smartphone app" />
              </div>
            </div>
          </div>
          ...
          <div className="workplace-section-cta">
            <div className="container">
              <h2>The Corporate Wellness Program<br />You Need At Your Workplace</h2>
        ...
        <div className="workplace-modalbg" 
          ...
          <div className="workplace-modal">
            ...
            <div className="modal-close" onClick={this.handleClick}>
              <img src={withPrefix('/static/icons/close-dark.svg')} alt="close icon" onClick={this.handleClick}/>
            </div>
        ...
        <div className="footer-info">
          <div className="container">
            <div className="footer-info__col1">
              <img src={withPrefix('/static/fitato-logo-colored.svg')} alt="fitato" style={{width: '120px'}}/>
              <p>The Fitato for Workplace program is a corporate health and wellness program designed specially for the modern Indian workplace. Diet plans, workout plans, team building exercises - it's the only wellness membership your office will ever need!</p>
            </div>

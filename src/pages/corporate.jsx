...
class WorkplacePage extends React.Component {
  ...
  handleClick = (e) => {
    if (
      e.target.className === 'workplace-modalbg' ||
      e.target.className === 'modal-close' ||
      e.target.parentElement.className === 'modal-close'
    ) {
      this.setState({
        modalToggle: false,
      });
  ...
  render() {
    return (
      <Layout>
        ...
        <div className="workplace-page">
              ...
              <div className="workplace-section-your__items">
                <div className="workplace-section-your__item">
                  ...
                  <p>
                    ...
                    wellness program includes activities and exercises that
                    boost productivity, decreas stress levels, increase
                    creativity and guarantee great results. Show your employees
                    you care with our corporate wellness program.
                  </p>
                </div>
                <div className="workplace-section-your__item">
                  <img
                  ...
                  <p>
                    ...
                    mean less absenteeism, better performance, and faster
                    results. Employees are the most important asset in your
                    organization and your healthy, happy employees will stay
                ...
                <div className="workplace-section-your__item">
                  ...
                  <h3>Socially Fit</h3>
                  <p>
                    Tough times never last, tough teams do. Our workplace
                    wellness program boosts employee morale and encourages
                    camaraderie and teamwork. Happier employees support each
          ...
          <div className="workplace-section-about">
            <div className="container">
              ...
              <p>
                ...
                - so your employees can access gyms they want, whenever and
                wherever they want.
              </p>
              <p>
                What’s more, our customized corporate plans bring you a variety
                of on-demand fitness sessions right at your workplace.
              </p>
              <p>
              ...
              <div className="workplace-section-employees__wrapper">
                ...
                <div className="workplace-section-employees__row">
                  <div>
                    <h3>For Employees</h3>
                    <p>
                      Each and every one of your employees and team members get
                      a flexible fitness plan they’re bound to love. Customised
                ...
                <div className="workplace-section-employees__row">
                  ...
                  <div className="workplace-section-employees__row--c2">
                    <h3>For Employers</h3>
                    <p>
                      It’s very difficult to make everyone happy. And run it
                      well! Fitato For Workplaces is built for the new age
                      workplace. All the stats you need, on a single dashboard.
                      Plus a range of in-office activities you can choose from.
                    </p>
          ...
          <div className="workplace-section-why">
            <div className="container">
              ...
              <span className="button align-center" onClick={this.handleClick}>
                Arrange a Call Back
              </span>
            </div>
          </div>
              ...
              <div className="workplace-section-plans__items">
                ...
                <div className="workplace-section-plans__item">
                  ...
                  <div className="workplace-section-plans__item--content">
                    ...
                    <p>
                      Monthly fitness/wellness sessions in the office campus
                    </p>
        ...
        <div
          className="workplace-modalbg"
          style={this.state.modalToggle ? displayBlock : displayNone}
          onClick={this.handleClick}>
          ...
          <div className="container">
            <div className="footer-info__col1">
              ...
              <p>
                ...
                it&apos;s the only wellness membership your office will ever
                need!
              </p>
            </div>

...
const PartnersPage = () => (
  <Layout>
    ...
    >
      ...
      <meta property="og:description" content="View the list of all the Fitness centers partnered with us. Everything Crossfit to MMA, Swmming to yoga, Boxing to Zumba and lot more."/>
    </Helmet>
    <div className="partners-page">
      <div className="container">
        ...
        <Accordion allowMultiple>
          ...
          <AccordionItem title="Kukatpally" className="accordion-item" expandedClassName="accordion-item-active">
            <img src={withPrefix('/static/partners/hyderabad/kukatpally.jpg')} alt="fitato partners in kukatpally hyderabad" />
          </AccordionItem>
          ...
          <AccordionItem title="Secunderabad" className="accordion-item" expandedClassName="accordion-item-active">
            <img src={withPrefix('/static/partners/hyderabad/secunderabad-2.jpg')} alt="fitato partners in secunderabad hyderabad" />
          </AccordionItem>

          ...
          <div className="reviews-page-content__col">
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                and more popular across Pune hopefully in other cities
                soon&quot;
              </p>
              <img
            ...
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                they can use. You have raised the bar for fitness .. I would
                love to see fitato getting into organising social sports event
                for volleyball, basketball, swimming ( no cricket or
                football)... Especially for travellers who want to workout while
                hopping different cities this is the best place ... I don&apos;t
                see why I won&apos;t use fitato on my next visit back home ..
                Thanks for such a brilliant app . I hope it&apos;s just gets
                better and come&quot;
              </p>
              <img
                src={withPrefix('/static/icons/comma.svg')}
            ...
            <div className="reviews-page-content__item">
              ...
              <h3>Sneha Goyal</h3>
              <p>
                &quot;Excellent concept and execution.Love the flexibility to
                try and experience a number of quality gyms and fitness studios
                that fitato offers at such minimal rates. Hats off to the fitato
          ...
          <div className="reviews-page-content__col">
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                attend Pilates classes, Yoga studios or the other vastly
                available fitness options, that too at a very nominal price.
                Fitato makes it possible &amp; I have finally found activities I
                love&quot;
              </p>
              <img
                src={withPrefix('/static/icons/comma.svg')}
            ...
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                customer service by Karan. Every week I access about 4
                activities - gym, swimming, functional training and spinning.
            ...
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                and adventure junkie I hated being tied down to a particular
                gym. With Fitato, it&apos;s like a new adventure waiting for you
                every day, sheer variety in fitness with a single pass&quot;
              </p>
              <img
                src={withPrefix('/static/icons/comma.svg')}
                alt="comma"
          ...
          <div className="reviews-page-content__col">
            ...
            <div className="reviews-page-content__item">
              ...
              <p>
                ...
                Rutusha, when she told me you can go to any possible gym near
                your area I was like wow ! I tried and explored all the possible
                options near my area in Pune. The best part is the people
                associated with Fitato Saransh, Aditya and Divyanshu and are
                very cooperative and will provide you with all the possible
                information required. I chose the flexi pass option which was
                the best according to my time and need. All the best Guys I hope
                you come up with other cities soon so one can get the best out
                of the fitness clubs and gyms and help ppl to stay fit and
                healthy&quot;
              </p>
              <img
                src={withPrefix('/static/icons/comma.svg')}

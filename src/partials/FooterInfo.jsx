  ...
  <footer className="footer-info">
    <div className="container">
      <div className="footer-info__col1">
        ...
        <p>
          Own a gym? Or a Health and Fitness Studio? Partner up with us and
          watch as your business reaches unprecedented heights in revenue and
          brand visibility. Tap into our customer base and put your fitness
          studio on the map!
        </p>
        <a
          href="https://partner.fitato.fit/"
          target="_blank"
      ...
      <div className="footer-info__col2">
        ...
        <ul className="footer-ul">
          ...
          <li>
            <Link to="/corporate/">Fitato For The Workplace</Link>
          </li>
          <li>

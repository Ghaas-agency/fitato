...
const MCForm = ({ formClass }) => (
  <div id="mc_embed_signup" className="partial-mc-form">
    <form
      action="https://fit.us18.list-manage.com/subscribe/post?u=c70dd7220cee163ff5b3fa95d&amp;id=537f4ff9ae"
      method="post"
      id="mc-embedded-subscribe-form"
      name="mc-embedded-subscribe-form"
      className={formClass ? `validate ${formClass}` : 'validate'}
      target="_blank"
      noValidate>
      <div id="mc_embed_signup_scroll" className="partial-mc-form__main">
        ...
        <div className="clear mc-form-submit-btn">
          ...
          <div
            style={{ position: 'absolute', left: '-5000px', margin: '0' }}
            aria-hidden="true">
            <input
              type="text"
              name="b_c70dd7220cee163ff5b3fa95d_537f4ff9ae"
              tabIndex="-1"
            />
          </div>
          <input
